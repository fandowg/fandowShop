  ...
  >
    <div class="edit">
      <ValidationObserver v-slot="{ handleSubmit }">
        <button @click="$emit('close')" class="close"><img src="@/assets/images/icon_close.svg" alt="" /></button>
        <h2><span v-if="isNew">新增</span><span v-else>編輯</span>產品</h2>
        <div class="edit-row form-row">
          <div class="one bag form-group">
        ...
        <div class="edit-row form-row">
          <div class="one bag-md-6 form-group">
          ...
          <div v-if="editTemp.imageUrl" class="one bag-md-6 form-group">
        ...
        <div class="edit-row form-row">
          <div class="one bag-6 form-group">
            <ValidationProvider
              name="分類"
              rules="required"
              v-slot="{ failed, errors }"
        ...
        <div class="buying-btn no-delete">
          <button href="#/payment" class="btn btn-outline-primary" @click="$emit('close')">取消</button>
          <button class="btn btn-primary" @click="handleSubmit(updateProduct)">送出</button
          >
        </div>
